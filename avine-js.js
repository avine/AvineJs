...
/*(function (window) {
	...
	Core.prototype = {
		...
		clone: function (callback, listeners) {
			...
			Clone.prototype.constructor = Clone; // Correct 'Clone' constructor pointer
			this.constructor = thisConstructor; // Restore 'this' constructor pointer
			// Process the cloning !
			var clone = new Clone();
		...
		setter: function (key, value) {
			if (arguments.length) this[key] = value;
		},
...
(function (window) {
	...
	var avine = window.avine; if (!avine || !avine.tool || !avine.dom) return; var tool = avine.tool, dom = avine.dom;
